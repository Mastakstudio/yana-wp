    ...
    <div class="footer__content">
        ...
        <div class="footer__inner-footer">
            <div class="footer__inner">
                <div class="footer__wrapper-logo"><a class="footer__logo" href="#"><img class="footer__image-logo"
                                                                                        src="/wp-content/themes/Yana/src/icons/logo.svg"
                        ...
                        <div class="footer__inner-wrapper">
                            <div class="social social__footer">
                                <div class="social__list"><a class="social__item" href="">
                                        <svg class="social__image" width="29" height="30" viewbox="0 0 29 30"
                                             fill="none">
                                        ...
                                        <svg class="social__image" width="35" height="25" viewbox="0 0 35 25"
                                             fill="none">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div class="footer__links"><a class="footer__link" href="#">Карта сайта</a><a
                                        class="footer__link" href="#">Интерактивная карта “Ты не одна”</a>
                            </div>
                            <img class="footer__image" src="/wp-content/themes/Yana/src/icons/canada.png" alt=""
                                 role="presentation"/><a class="footer__develop" href=""><span
                                        class="footer__develop-title">Developed:</span><img class="footer__develop-image"
                                                                                            src="/wp-content/themes/Yana/src/icons/develop.svg"
                                                                                            alt="" role="presentation"/></a>
                        </div>
                    </div>
                </div>
