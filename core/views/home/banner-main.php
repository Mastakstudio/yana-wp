...
<div class="banner-main">
    <div class="container">
        <div class="banner-main__inner">
            <div class="banner-main__content"><span
                    class="title title_blue">ОБУЧАЮЩИЙ КУРС «БЕРЕМЕННОСТЬ И РОДЫ»</span>
                <p class="text text_black">Онлайн курс подготовлен в рамках проекта «Ты не одна» и ориентирован на
                    семьи, ожидающие рождение ребенка, и на молодых родителей. В курсе Вы узнаете в легкой форме,
                    как счастливо пройти всю беременность, подготовится к родам, материнству и отцовству.</p><a
                    class="banner-main__link" href="#modal"><span>Просмотреть приветствие</span><img
                        src="/wp-content/themes/Yana/src/icons/play.png" alt="" role="presentation"/></a><img
                    class="banner-main__girl-write" src="/wp-content/themes/Yana/src/icons/girl-write.png"
...
<div class="popup">
    <div class="remodal" data-remodal-id="modal">
        ...
        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/jemgIOAjGDw" frameborder="0"
